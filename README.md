...
### Install
`npm i @firanorg/quasi-commodi-fugit`
...
```javascript
const {CStructBE,CStructLE, hexToBuffer, AtomTypes} = require('@firanorg/quasi-commodi-fugit');
...
**Make example**<br>
```typescript
import { CStructBE, CStructProperty } from '@firanorg/quasi-commodi-fugit';
...
```typescript
import { CStructBE, CStructClass } from '@firanorg/quasi-commodi-fugit';
...
### [Many examples are in this folder '/examples'](https://github.com/firanorg/quasi-commodi-fugit/tree/main/examples)

### Basic examples
```typescript
import { CStructBE } from '@firanorg/quasi-commodi-fugit';
...
**NOTE** Take a look on ['/examples/decorators.ts'](https://github.com/firanorg/quasi-commodi-fugit/tree/main/examples/decorators.ts)
...
```typescript
import { CStructBE, CStructClass, CStructModelProperty } from '@firanorg/quasi-commodi-fugit';
...
### [TODO](https://github.com/firanorg/quasi-commodi-fugit/blob/main/doc/TODO.md)
